...
package minn.util
{
	...
	public final class MinnUtil
	{
		...
		public static function send(pro:Proxy,sname:String,method:String,eventType:String,obj:*=null):void{
			 ro=new RemoteObject();
...
//					m.otherInfo=obj;
			...
			if(obj!=null){
				trace("MinnUtil.send 传送的字符串参数："+JSON.encode(obj.item));
				param=JSON.encode(obj.item);
//				Alert.show(param);
...
//			if(loader==null)
			...
			request.method = "post";
			param.photos=encodeURIComponent(JSON.encode(filearr));
