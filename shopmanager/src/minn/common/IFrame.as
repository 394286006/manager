...
//			Alert.show(e.type);
			if(_uuid)
			  if(e.type==MouseEvent.MOUSE_MOVE||e.type==ResizeEvent.RESIZE)
	...
	public function moveIFrame(): void
	{
		...
		ExternalInterface.call("moveIFrame", _uuid,globalPt.x+"px",globalPt.y+2+"px",this.width+3+"px", this.height+2+"px");
	}
